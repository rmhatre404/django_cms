...
SECRET_KEY = "django-insecure-6apmt4p$xo0o(-2*#nm7pd-m_3oouolyp(u$sgwic%vcw38*^o"
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    },
    {
        ...
        "OPTIONS": {
            "min_length": 8,  # Ensures a minimum of 8 characters
        },
    },
    {
...
SIMPLE_JWT = {
    ...
    'ROTATE_REFRESH_TOKENS': True,  # Optional: Rotates refresh token upon use
